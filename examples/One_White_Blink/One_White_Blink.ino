/*  * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  Author: Amay Kataria
  Date: 05/06/2018
  Description: This example lets you blink an LED at a rate.
  This rate is controlled by a variable called blinkTime. 
  The color of the LED can be changed in led.setColor(). Value
  lies between 0-255. 
